package ua.nure.chekhunov.summarytask4.servlets.users;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (null != request.getParameter("actionName")) {
            ...
            try {
                ...
                List<Order> resList = DBManager.getInstance().getUsersOrders(currentUser.getUserId(), offset, PER_PAGE);
                int numberOfOrders = DBManager.getInstance().getUsersNumberOfOrders(currentUser.getUserId());
