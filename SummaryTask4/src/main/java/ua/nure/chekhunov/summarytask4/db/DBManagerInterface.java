...
public interface DBManagerInterface {
    ...
    /**
     * Adds row in 'orders' table if input login and
     * email are not already registered.
     *
     * @param name
     * @param login
     * @param password
    ...
    /**
     * Checks if input parameters login and password
     * can be found in database
     *
     * @param login
     * @param password
   ...
   //
   int getAllCostOrder(int userId);
    int getAllCount(int userId);
    //
