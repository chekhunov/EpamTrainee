package ua.nure.chekhunov.practice7.util;
...
public class Util {
	...
	/**
	 * @param writer
	 * @param listedParameters
	 * @throws XMLStreamException - Parameters xml writer
	 */
	...
	/**
	 * @param writer
	 * @param listedCallPrice
	 * @throws XMLStreamException - CallPrice xml writer
	 */
